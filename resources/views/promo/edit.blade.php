                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="" value="{{$promo->title}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="images" class="custom-file-input" value="{{$promo->images}}" id="inputGroupFile02" aria-describedby="inputGroupFileAddon01">
