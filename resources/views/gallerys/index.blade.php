            ...
            <div class="col-md-6 mb-3">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <form action="{{route('gallery.store')}}" method="POST" enctype="multipart/form-data" class="was-validated">
                            @csrf
                            @if(session('success'))
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-info">Simpan Gallery</button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('gallery.delete',$gallery->id)}}" method="post">
                                        ...
                                        <a href="{{route('gallery.edit',$gallery->id)}}" class="btn btn-info btn-sm">Edit</a>
